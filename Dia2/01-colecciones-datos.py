...
print("Lista Combinada: ",seccion_a + seccion_b)
...
print("this is TRUE OR FALSE RIGHT?: ", '2' in variada)
...
print("CORREO: ",persona.get("correo"))
...
print("tuplas form: ",persona.items())
